...
def main(video_file):
    ...
    while True:
        ...
        if count >= 9899:       #   In (seconds * fps). 9899 means the number of frames till 5m30s of a video at 30 fps. (330s * 30fps)
          break
        ...
        if frame_duration >= closest_duration:
            ...
            print(xx, file = open("/media/zayed/UbuntuWorks/data/all_frames.txt", "a"))
            # images.append(img)
...
if __name__ == "__main__":
    ...
    for video_file in sorted(glob.glob("/media/zayed/UbuntuWorks/videos/*.mp4")):
